...
public class ConsumerTest {
	...
	public static void main(String[] args) {
		...
		myConsumer.accept("점심시간");
		myConsumer.accept("토마토계란볶음");
		myConsumer.accept("마싯더");
		
		Consumer<Integer> myConsumer2 = x -> System.out.println("정수형 리스트 입력값 처리 :" + x );
		myConsumer2.accept(3);
		System.out.println();
