...
public class CustomerTest02 {
	...
	public static void main(String[] args) {
		...
		Customer customerG = new GoldCustomer(2020, "아무나");
		customerG.bonusPoint = 1100;
		int priceG = customerG.calcPrice(1100);
		System.out.println(customerG.showInfo() + "지불금액은" + priceG + "원 입니다.");
